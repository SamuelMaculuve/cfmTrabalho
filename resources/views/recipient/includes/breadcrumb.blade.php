<div class="mail-body-header">
    ...
    <div class="btn-group dropdown-split-primary">
        ...
        <div class="dropdown-menu">
            <a class="dropdown-item waves-effect waves-light" href="#recipients_type_new" data-toggle="pill" role="tab">Nova</a>
            <a class="dropdown-item waves-effect waves-light" href="#recipient_type" data-toggle="pill" role="tab">Todos</a>
        </div>
    </div>
</div>
