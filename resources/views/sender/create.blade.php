                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control border-form-control" required="required" name="name" value="" placeholder="Insira o seu primeiro nome" type="text">
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label class="control-label">Apelido <span class="required">*</span></label>
                                                        <input class="form-control border-form-control"  required="required" name="surname" value="" placeholder="Insira o seu apelido" type="text">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control border-form-control " value="" name="email" placeholder="iamosahan@gmail.com"  type="email">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label class="control-label"> <span class="required"> Selecione o País</span></label>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control border-form-control" value="" name="document_name" placeholder="123456" type="number">
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-12">
                                            <div class="col-md-12">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            <label class="control-label">Tipo de funcionario <span class="required">*</span></label>
